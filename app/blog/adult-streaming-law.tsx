    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section id="sec1" className="mb-12">
        ...
        <p className="text-gray-700 leading-relaxed">
          「動画配信」と聞くとStripchatやmyfansなどライブ配信や動画販売だけをイメージしがちですが、警察庁の解釈運用基準は「映像」には静止画も含まれるとしています。つまり、会員制ページでの画像閲覧・有料画像投稿・課金制の写真コンテンツなども、内容と実態によっては同じ類型で検討されることになります。動画でなければ大丈夫という理解は危険で、結局は「性的な行為を表す場面」や「衣服を脱いだ人の姿態」を営業としてネット上で見せているかが判断の中心になります。
        </p>
      </section>
