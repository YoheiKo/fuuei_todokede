    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-12 text-gray-700 leading-relaxed">
        ...
        <section id="sec3" className="scroll-mt-24">
          ...
          <Image
            src="/images/sample/kaigai_1.png"
            alt="映像送信型性風俗特殊営業届出の要否を判断する３つのポイント（営業主体・事務所所在地・日本向け営業実態）"
            width={1672}
            height={941}
        ...
        <section id="sec4" className="scroll-mt-24">
          ...
          <div className="space-y-4">
            <p className="text-gray-700 leading-relaxed">
              海外サーバーの論点と似ていますが、外部プラットフォームを使っていることも、届出不要の決め手にはなりません。警視庁は映像送信型性風俗特殊営業をホームページごとの届出と整理しており、独自サイトだけでなく、実質的な営業ページがどこかを問題にしています。たとえば、StripchatやOnlyFansのような海外のプラットフォームを利用して成人向け配信・コンテンツ販売を行う場合でも、配信者や運営者の拠点が日本国内にある場合には、そのページを用いた営業として届出の検討が必要です。プラットフォームが海外法人であっても、それを利用する営業主体が日本国内にある以上、届出義務を免れる根拠にはなりません。
            </p>
          </div>
        </section>
        ...
        <section id="sec5" className="scroll-mt-24">
          ...
          <Image
            src="/images/sample/kagai_2.png"
            alt="映像送信型性風俗特殊営業届出で誤解しやすいポイントと注意が必要なケース（海外サーバー・海外法人名義・外部プラットフォーム利用）"
            width={1672}
            height={941}
            className="w-[85%] mx-auto h-auto rounded-lg my-10"
          />
