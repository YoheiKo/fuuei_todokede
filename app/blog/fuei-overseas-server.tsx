    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-12 text-gray-700 leading-relaxed">
        ...
        <section id="sec4" className="scroll-mt-24">
          ...
          <div className="space-y-4">
            <p className="text-gray-700 leading-relaxed">
              海外サーバーの論点と似ていますが、外部プラットフォームを使っていることも、届出不要の決め手にはなりません。警視庁は映像送信型性風俗特殊営業をホームページごとの届出と整理しており、独自サイトだけでなく、実質的な営業ページがどこかを問題にしています。したがって、海外プラットフォームや国外サービスを使っていても、日本国内の営業主体がそのページを用いて営業している場合には、届出の検討が必要です。
            </p>
          </div>
        </section>
