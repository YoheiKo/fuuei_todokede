      ...
      <div className="space-y-12 text-gray-700 leading-relaxed">
        ...
        <section id="sec1" className="scroll-mt-24">
          ...
          <div className="space-y-4 mb-6">
            ...
            <p>
              ここで重要なのは、日常的に使われる「デリヘル」という言葉と、法律上の「無店舗型性風俗特殊営業」という言葉が一致しないことです。事業者側はデリヘル開業と考えていても、法的には無店舗型性風俗特殊営業として届出を行う必要があります。
            </p>
          </div>
        ...
        <section id="sec8" className="scroll-mt-24">
          ...
          <div className="space-y-4">
            ...
            <p>
              事務所選びに不安がある方、個人と法人のどちらで進めるべきか迷っている方、警察署への申請をスムーズに進めたい方は、早めに行政書士へ相談することを推奨します。最初の届出をきちんと整えることが、その後の集客、採用、営業のしやすさにもつながります。
            </p>
          </div>
        </section>
