  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-700 leading-relaxed mb-10">
        映像送信型性風俗特殊営業や無店舗型性風俗特殊営業の届出を検討している方から多く寄せられるのが「レンタルオフィスでも事務所として使えるのか」という質問です。特に、映像送信型性風俗特殊営業や無店舗型性風俗特殊営業のように、店舗を持たずに営業する形では、「自宅は避けたい」「できるだけ初期費用を抑えたい」「まずは小さく始めたい」という理由から、レンタルオフィスやシェアオフィスを候補にする方が多いです。ですが、結論から言えば、レンタルオフィスなら必ず届出できるとも、逆に一律にできないとも言えません。重要なのは、その物件で風営法上の「事務所」としての実態と使用権原を説明できるかどうかです。
      </p>
      ...
      <section id="sec6" className="mb-12">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              建物所有者またはレンタルオフィス運営者が、当該営業の事務所として使用することについて承諾を出せるかを確認します。使用承諾書は公式案内でも例示されているため、ここが曖昧だと大幅に厳しくなります。契約前に確認した方が安全です。
            </p>
          </div>
          <div className="bg-white border border-gray-200 rounded-xl p-5">
      ...
      <section id="sec8" className="mb-12">
        <h2 className="text-xl font-bold text-gray-900 border-b-2 border-violet-200 pb-2 mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            物件を先に借りてから悩むより、契約前に「使用承諾が出るか」「専用スペースを示せるか」「この営業の事務所として説明できるか」を確認することが重要です。少しでも判断に迷うなら、営業開始前の段階で行政書士へ相談し、事務所要件を固めてから進めることを推奨します。
          </p>
      </section>
