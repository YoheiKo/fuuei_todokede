...
export const meta: PostMeta = {
  ...
  title: "映像送信型性風俗特殊営業の届出が不要なケースはある？ | 行政書士が解説",
  description:
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-4 text-gray-700 leading-relaxed mb-10">
        ...
        <p>
          ただし、重要なのは、映像送信型性風俗特殊営業の届出が不要かどうかは、サービス名や本人の感覚だけでは決まらないという点です。風営法は、専ら性的好奇心をそそるため、性的な行為を表す場面又は衣服を脱いだ人の姿態の映像を、電気通信設備を用いて客に見せる営業を映像送信型性風俗特殊営業として定義しています（風営法第2条第8項）。警察庁の解釈運用基準では、この「映像」には静止画だけでなく動画も含まれるとされており、「専ら」に当たるかどうかも営業者の意図と営業実態を踏まえて判断すると整理されています。
        </p>
        <p>
        ...
        <p>
          本記事では、映像送信型性風俗特殊営業の届出が不要と整理しやすいケースと、直ちには不要と言い切れないケースを分けながら、判断のポイントを行政書士が解説します。
        </p>
      </div>
      ...
      <div className="space-y-12 text-gray-700 leading-relaxed">
        ...
        <section id="sec1" className="scroll-mt-24">
          ...
          <div className="space-y-4">
            <p className="text-gray-700 leading-relaxed">
              誤解が生じやすい点として、「個人のクリエイター活動だから」「小規模だから」「趣味の延長だから」といった理由で対象外と考えてしまうケースがあります。しかし、公的資料上、そのような区別はありません。法が見ているのは、性的映像を、専ら性的好奇心をそそるために、営業として見せているかどうかです。規模や肩書きだけでは判断できません。
            </p>
          </div>
        </section>
        ...
        <section id="sec2" className="scroll-mt-24">
          ...
          <div className="space-y-4 mb-6">
            <p className="text-gray-700 leading-relaxed">
              法の定義は「営業」であることを前提にしています。そのため、継続的な収益化や営業構造がなく、単発的で、営業としての実態がないケースでは、直ちに典型的な映像送信型性風俗特殊営業とは言いにくいことがあります。ただし、この点は慎重に確認すべき部分です。本人は「試験的に一回だけ」と考えていても、会員募集や有料導線、販売ページが整っていれば、客観的に見た営業性は高くなるからです。これは警察庁の解釈運用基準が実態判断を重視していることからも分かります。
            </p>
          </div>
        ...
        <section id="sec3" className="scroll-mt-24">
          ...
          <div className="space-y-4 mb-6">
            <p className="text-gray-700 leading-relaxed">
              独自サイトではなく、Stripchat（ストリップチャット）、Fantia、Myfans、CandFansなどの外部プラットフォームや会員制サービスを使っている場合でも、直ちに届出不要にはなりません。警視庁は「ホームページごとの届出」としており、独自ドメインに限るとは書いていません。実質的に営業ページとして機能している会員ページや販売ページがあるなら、それを無視してよいとは言えません。
            </p>
          </div>
